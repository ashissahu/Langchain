...
from langchain.chat_models import init_chat_model #importing init_chat_model function .
...
def run_agent(question: str):
    ...
    llm = init_chat_model(f"openai:gpt-5.2", temperature=0) #not working properly with gpt -5.2
    #llm = init_chat_model(f"openai:gpt-4o", temperature=0) #not working properly with gpt -4o or gpt 5.1
    llm_with_tools = llm.bind_tools(tools) # binds the tools to llm.Only works if llm supports function calling

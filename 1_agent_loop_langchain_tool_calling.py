#Using OLLAMA
#Langsmith Tracing - https://smith.langchain.com/o/a7f8bd85-b797-5733-8038-ce1ba498c5e8/projects/p/c0e96a90-463d-4a42-9498-1733220e0a8d?columnVisibilityModel_runs%3AcolumnVisibilityModel%3Adefault=%7B%22feedback_stats%22%3Afalse%2C%22reference_example%22%3Afalse%7D&peek=20260511T183747Z019e1854-bf4c-7931-8175-cf58fa628b09&peeked_trace=20260511T183747724901Z019e1854-bf4c-7931-8175-cf58fa628b09&scroll_to=input
...
def run_agent(question: str):
    ...
    llm = init_chat_model(f"ollama:{MODEL}", temperature=0) #This initializes a chat model using the init_chat_model function. The model is specified as "ollama:qwen3:1.7b", which indicates that we want to use the Qwen 3 1.7B model from Ollama. The temperature parameter is set to 0, which means that the model will generate deterministic responses (i.e., it will always generate the same response for the same input). This is useful for testing and debugging, as it allows us to see consistent behavior from the model.
